# =============================================================================
# Forge - Ada Lovelace (RTX 40-series)
# Optimized for RTX 4090, 4080, 4070, 4060
# CUDA 12.4, PyTorch 2.6, BF16 support
# =============================================================================
...
# Install PyTorch with CUDA 12.4 (stable, Ada optimized)
...
RUN pip install "unsloth[cu124-torch260] @ git+https://github.com/unslothai/unsloth.git"
